...
if __name__ == "__main__":
    ...
    parser.add_argument('--B', type=int, help='Number of resBlocks', default=32)  # 32
    parser.add_argument('--F', type=int, help='Number of filters', default=256)  # 256
    ...
    parser.add_argument('--epochs', type=int, help='Number of epochs during training', default=50)
    parser.add_argument('--lr', type=float, help='Learning_rate', default=0.0001)

    # paths
    parser.add_argument('--image', help='Specify test image folder', default="./testing_lr_images/")
